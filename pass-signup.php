...
<head>
    ...
    <title>Online Ticket Management System</title>
      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
                ...
                <form method ="POST">
                  <div class="login-form">
                    ...
                    <div class="form-group">
                      <input class="form-control" name="pass_fname" type="text" placeholder="Enter Your First Name" autocomplete="off" required>
                    </div>
                    <div class="form-group">
                      <input class="form-control" name="pass_lname" type="text" placeholder="Enter Your Last Name" autocomplete="off" required>
                    </div>
                    <div class="form-group">
                      <input class="form-control" name="pass_phone" type="text" placeholder="Enter Your Phone Number" autocomplete="off" required>
                    </div>
                    <div class="form-group">
                      <input class="form-control" name="pass_addr" type="text" placeholder="Enter Your Address" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <input class="form-control" name="pass_uname" type="text" placeholder="Enter Your Username" autocomplete="off" required>
                    </div>
                    <div class="form-group">
                      <input class="form-control" name="pass_email" type="email" placeholder="Enter Your Email Address" autocomplete="off" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="splash-footer">&copy; 2023 - <?php echo date ('Y');?> Online Ticket Management System| Developed By Group 13</div>
