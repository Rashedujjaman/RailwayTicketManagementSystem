        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card card-table">
              ...
              // // Modify your SELECT query to retrieve only unpaid tickets
              // $ret = "SELECT * FROM orrs_passenger WHERE pass_id = ? AND payment_status = 0"; // Assuming 0 indicates unpaid
              // // Rest of your code remains the same for displaying the tickets
              ...
              while ($row = $res->fetch_object()) {
                ...
                <div class="card-header">
                  ...
                  <?php echo $row->pass_lname; ?> This Is Your Booked Train Ticket Proceed to Confirm checkout your ticket!
                <?php } ?>
              </div>
                  ...
                  <tbody>
                    ...
                    while ($row = $res->fetch_object()) {
                      ...
                      <tr class="odd gradeX even gradeC odd gradeA even gradeA ">
                        <td>
                          <?php echo $row->pass_train_number; ?>
                        </td>
                        <td>
                          <?php echo $row->pass_train_name; ?>
                        </td>
                        <td class="center">
                          <?php echo $row->pass_dep_station; ?>
                        </td>
                        <td class="center">
                          <?php echo $row->pass_arr_station; ?>
                        </td>
                        <td class="center">
                          <?php echo $row->pass_dep_time; ?>
                        </td>
                        <td class="center">RM
                          <?php echo $row->pass_train_fare; ?>
                        </td>
                        <td class="center">
                          <?php echo $row->pass_fare_payment_code; ?>
                        </td>
                        <td class="center"><a
                            href="pass-confirm-checkout-ticket.php?pass_id = <?php echo $row->pass_id; ?>"><button
                              class="btn btn-sm btn-success">Confirm Payment</button></a></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>
